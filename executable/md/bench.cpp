...
int main(int argc, char const *argv[]) {
    ...
    settings::general::output += "md/bench/" + s_pdb.stem() + "/";
    ...
    SystemSettings ss {
        ...
        .watermodel = option::WaterModel::TIP3P,
    ...
    auto molecule = simulate_molecule({
        .system = ss,
        .pdbfile = pdb,
        .mdp_equilibration = mdp_prod_file,

...
TEST_CASE("VolumetricConstraints::generate") {
    ...
    SECTION("simple") {
        ...
        Atom a3 = Atom(Vector3<double>(0,  0, -1*distance), 1, "C", "C", 1);
        Atom a4 = Atom(Vector3<double>(0,  1*distance,  0), 1, "C", "C", 1);
        Atom a5 = Atom(Vector3<double>(0, -1*distance,  0), 1, "C", "C", 1);
        Atom a6 = Atom(Vector3<double>( 1*distance, 0,  0), 1, "C", "C", 1);
        Atom a7 = Atom(Vector3<double>(-1*distance, 0,  0), 1, "C", "C", 1);
        Atom a8 = Atom(Vector3<double>(0,  0,  2*distance), 1, "C", "C", 1);
        Atom a9 = Atom(Vector3<double>(0,  0,  3*distance), 1, "C", "C", 1);

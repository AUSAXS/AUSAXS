...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "914aeecfe23b1e16af6ea675a4fb5dbd5a5b8d0a"
  WORKING_DIRECTORY "/home/runner/work/AUSAXS/AUSAXS/_codeql_build_dir/_deps/catch2-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "914aeecfe23b1e16af6ea675a4fb5dbd5a5b8d0a")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("914aeecfe23b1e16af6ea675a4fb5dbd5a5b8d0a" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 914aeecfe23b1e16af6ea675a4fb5dbd5a5b8d0a")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/914aeecfe23b1e16af6ea675a4fb5dbd5a5b8d0a")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"914aeecfe23b1e16af6ea675a4fb5dbd5a5b8d0a\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/AUSAXS/AUSAXS/_codeql_build_dir/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/AUSAXS/AUSAXS/_codeql_build_dir/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

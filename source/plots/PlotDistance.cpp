...
PlotDistance::PlotDistance(std::observer_ptr<hist::ICompositeDistanceHistogram> d, const io::File& path) {
    quick_plot(d, path);
}

void PlotDistance::quick_plot(std::observer_ptr<hist::ICompositeDistanceHistogram> d, const io::File& path) {

...
std::unique_ptr<ParameterGenerationStrategy> rigidbody::factory::create_parameter_strategy(std::unique_ptr<rigidbody::parameter::decay::DecayStrategy> decay_strategy, double translate_amp, double rotate_amp, const settings::rigidbody::ParameterGenerationStrategyChoice& choice) {
    switch (choice) {

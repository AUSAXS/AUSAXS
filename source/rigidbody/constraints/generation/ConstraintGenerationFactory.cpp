...
std::shared_ptr<rigidbody::ConstraintGenerationStrategy> rigidbody::factory::generate_constraints(const ConstraintManager* manager, settings::rigidbody::ConstraintGenerationStrategyChoice choice) {
    switch (choice) {

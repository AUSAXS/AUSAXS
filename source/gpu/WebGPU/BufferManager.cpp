...
int ausaxs::gpu::BufferManager<weighted_bins>::manage_self(wgpu::Buffer buffer, int merge_id) {
    int res_idx;
...
template<bool weighted_bins>
int ausaxs::gpu::BufferManager<weighted_bins>::manage_cross(wgpu::Buffer buffer, int merge_id) {
    int res_idx;
...
template<bool weighted_bins>
void merge_buffer(ausaxs::gpu::GPUInstance& instance, typename ausaxs::hist::GenericDistribution1D<weighted_bins>::type& destination, wgpu::Buffer histogram_readback) {
...
template<bool weighted_bins>
std::vector<std::vector<wgpu::Buffer>> create_readback_buffers(const ausaxs::gpu::GPUInstance& instance, std::vector<std::vector<wgpu::Buffer>> hists) {
...
template<bool weighted_bins>
ausaxs::gpu::BufferManager<weighted_bins>::run_result ausaxs::gpu::BufferManager<weighted_bins>::merge(ausaxs::gpu::GPUInstance& instance) const {
    run_result result;
...
template struct ausaxs::gpu::BufferManager<false>;
template struct ausaxs::gpu::BufferManager<true>;
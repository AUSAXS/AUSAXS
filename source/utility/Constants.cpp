 ...
 */
namespace constants {
    const saxs::detail::SimpleMap<char> name_1symbol_map = std::map<std::string, char>{
    ...
    const saxs::detail::SimpleMap<std::string> name_3symbol_map = std::map<std::string, std::string>{
    ...
    namespace volume {
        const saxs::detail::SimpleMap<double> amino_acids = std::map<std::string, double>{
    ...
    namespace mass {        
        const saxs::detail::SimpleMap<double> atomic = std::map<std::string, double>{
    ...
    namespace charge {
        const saxs::detail::SimpleMap<unsigned int> atomic = std::map<std::string, unsigned int>{

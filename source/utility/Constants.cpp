 ...
 */
namespace constants {
    const detail::SimpleMap<char> name_1symbol_map = std::map<std::string, char>{
    ...
    const detail::SimpleMap<std::string> name_3symbol_map = std::map<std::string, std::string>{
    ...
    namespace volume {
        const detail::SimpleMap<double> amino_acids = std::map<std::string, double>{
    ...
    namespace mass {        
        const detail::SimpleMap<double> atomic = std::map<std::string, double>{
    ...
    namespace charge {
        const detail::SimpleMap<unsigned int> atomic = std::map<std::string, unsigned int>{
    ...
    namespace hydrogen_atoms {
        parser::ligand::ResidueStorage residues;
    }
}
...
GridObj::DATATYPE& GridObj::index(unsigned int x, unsigned int y, unsigned int z) {return grid[x][y][z];}
const GridObj::DATATYPE& GridObj::index(unsigned int x, unsigned int y, unsigned int z) const {return grid[x][y][z];}

GridObj::DATATYPE& GridObj::index(const Vector3<int>& v) {return index(v.x(), v.y(), v.z());}
const GridObj::DATATYPE& GridObj::index(const Vector3<int>& v) const {return index(v.x(), v.y(), v.z());}

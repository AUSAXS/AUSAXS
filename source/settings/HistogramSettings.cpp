...
template<> std::string settings::io::detail::SettingRef<settings::hist::HistogramManagerChoice>::get() const {
    switch (settingref) {
        ...
        case settings::hist::HistogramManagerChoice::HistogramManagerMTFFGrid1: return "hmmtffg1";
        case settings::hist::HistogramManagerChoice::HistogramManagerMTFFGrid2: return "hmmtffg2";
        case settings::hist::HistogramManagerChoice::HistogramManagerMTFFGrid3: return "hmmtffg3";
...
template<> void settings::io::detail::SettingRef<settings::hist::HistogramManagerChoice>::set(const std::vector<std::string>& val) {
    ...
    else if (str == "hmmtffg1") {settingref = settings::hist::HistogramManagerChoice::HistogramManagerMTFFGrid1;}
    else if (str == "hmmtffg2") {settingref = settings::hist::HistogramManagerChoice::HistogramManagerMTFFGrid2;}
    else if (str == "hmmtffg3") {settingref = settings::hist::HistogramManagerChoice::HistogramManagerMTFFGrid3;}

...
void mini::Landscape::append(std::vector<Evaluation> evals) {this->evals.insert(this->evals.end(), evals.begin(), evals.end());}

void mini::Landscape::append(Landscape evals) {append(evals.evals);}

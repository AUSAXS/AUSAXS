...
void CubicSpline::setup() {
    ...
    if (n != y.size()) {throw except::invalid_argument("CubicSpline::setup: x and y must have the same size.");}
    if (n == 0) {throw except::invalid_argument("CubicSpline::setup: x and y cannot be empty.");}

...
#include <hist/detail/HistogramManager.h>
...
namespace hist {
	...
	/**
	 * @brief A single-threaded smart distance calculator which efficiently calculates the scattering histogram.
	 */
	class PartialHistogramManager : public HistogramManager {
		...
		private:
			 ...
			 * @brief Calculate the atom-atom distances between body @a index and all others. 
			 */
			void calc_pp(unsigned int index, unsigned int start, unsigned int end);

			/**
			 * @brief Calculate the hydration-atom distances between the hydration layer and body @a index.
			 */
			void calc_hp(unsigned int index, unsigned int start, unsigned int end);

			/**
			 * @brief Calculate the hydration-hydration distances. 
			 */
			void calc_hh(unsigned int start, unsigned int end);

			/**
			 * @brief Calculate the self-correlation of a body. 
			 */
			void calc_self_correlation(unsigned int index, unsigned int start, unsigned int end);
	};
}
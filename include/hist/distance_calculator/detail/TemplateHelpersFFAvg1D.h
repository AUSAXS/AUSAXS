...
//  */
// template<bool use_weighted_distribution, bool calculate_weights, int factor>
...
//     if constexpr (calculate_weights) {
//         for (unsigned int k = 0; k < 8; ++k) {p.add(res.distances[k], factor*res.weights[k]);}
//     } else {
//         for (unsigned int k = 0; k < 8; ++k) {p.add(res.distances[k], factor);}
//     }
// }
...
//     } else {
//         for (unsigned int k = 0; k < 4; ++k) {p.add(res.distances[k], factor);}
//     }
// }

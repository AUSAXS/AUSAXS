            ...
            static FormFactorFoXS get_form_factor(form_factor_t type) {
                switch (type) {
                    ...
                    case form_factor_t::C:
                        return FormFactorFoXS(5.9992);
                    case form_factor_t::N:
                        return FormFactorFoXS(6.9946);
                    ...
                    case form_factor_t::CH2:
                        return FormFactorFoXS(7.99911);
                    case form_factor_t::CH3:
                        return FormFactorFoXS(8.99906);
                    case form_factor_t::NH:
                        return FormFactorFoXS(7.99455);
                    case form_factor_t::NH2:
                        return FormFactorFoXS(8.99451);
                    case form_factor_t::NH3:
                        return FormFactorFoXS(9.99446);
                    case form_factor_t::OH:
                        return FormFactorFoXS(8.99935);
        ...
        namespace exv {
            static FormFactorFoXS get_form_factor(form_factor_t type) {
                switch (type) {
                    ...
                    case form_factor_t::C:
                        return FormFactorFoXS(5.49096);
                    case form_factor_t::N:
                        return FormFactorFoXS(0.83166);
                    case form_factor_t::O:
                        return FormFactorFoXS(3.04942);
                    case form_factor_t::S:
                        return FormFactorFoXS(6.63324);
                    case form_factor_t::CH:
                        return FormFactorFoXS(7.21106);
                    case form_factor_t::CH2:
                        return FormFactorFoXS(8.93116);
                    case form_factor_t::CH3:
                        return FormFactorFoXS(10.6513);
                    case form_factor_t::NH:
                        return FormFactorFoXS(2.55176);
                    case form_factor_t::NH2:
                        return FormFactorFoXS(4.27186);
                    case form_factor_t::NH3:
                        return FormFactorFoXS(5.99196);
                    case form_factor_t::OH:
                        return FormFactorFoXS(4.76952);
                    case form_factor_t::SH:

...
namespace ausaxs::md {
    ...
    class MDPCreator {
        public:
            ...
            std::string& get(const MDPOptions::detail::Option& option);
            const std::string& get(const MDPOptions::detail::Option& option) const;
    ...
    namespace mdp::templates {
        namespace minimize {
            struct base : public MDPCreator {base();};
        }

        namespace equilibrate {
            struct base : public MDPCreator {base();};
            struct mol : public base {mol();};
            struct solv : public base {solv();};
        }

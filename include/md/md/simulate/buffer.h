...
namespace gmx {
    SimulateBufferOutput simulate_buffer(const BufferOptions& options) {
        ...
        Folder setup_path = options.output + "buffer/setup/";
        Folder em_path = options.output + "buffer/em/";
        Folder eq_path = options.output + "buffer/eq/";
        Folder prod_path = options.output + "buffer/prod/";

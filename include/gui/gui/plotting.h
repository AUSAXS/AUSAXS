...
namespace resources {
    ...
    extern const char *const plotting_script_helper;
...
inline constexpr const char* resources::plotting_script = R"""(
...
inline constexpr const char* resources::plotting_script_helper = R"""(
import matplotlib.pyplot as plt

...
namespace hist {
    class CompositeDistanceHistogramFFGridScalableExv : public CompositeDistanceHistogramFFAvg {
        private:
            struct RecalculateGridDists {
                std::pair<hist::WeightedDistribution2D, hist::WeightedDistribution1D> recalculate_x(double factor) {
                    return {};
                }
            };

        public:
            CompositeDistanceHistogramFFGridScalableExv(CompositeDistanceHistogramFFGridScalableExv&&) noexcept;
            CompositeDistanceHistogramFFGridScalableExv& operator=(CompositeDistanceHistogramFFGridScalableExv&&) noexcept;
            ~CompositeDistanceHistogramFFGridScalableExv() override;
             ...
             */
            CompositeDistanceHistogramFFGridScalableExv(
    ...
    static_assert(supports_nothrow_move_v<CompositeDistanceHistogramFFGridScalableExvScalableExv>, "CompositeDistanceHistogramFFGridScalableExvScalableExv should support nothrow move semantics.");
}
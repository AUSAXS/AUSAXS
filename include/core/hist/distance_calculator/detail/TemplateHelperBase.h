...
namespace ausaxs::hist::detail {
    namespace add16 {
        ...
        template<bool variable_bin_width>
        inline hist::detail::xyzff::HexaEvaluatedResult evaluate_weighted(const hist::detail::CompactCoordinatesFF<variable_bin_width>& data_i, const hist::detail::CompactCoordinatesFF<variable_bin_width>& data_j, int i, int j) {
            return data_i[i].evaluate_16(std::span<std::remove_reference_t<decltype(data_j[j])>, 16>(&data_j[j], 16));
        }

        template<bool variable_bin_width>
        inline hist::detail::xyzff::HexaEvaluatedResultRounded evaluate_unweighted(const hist::detail::CompactCoordinatesFF<variable_bin_width>& data_i, const hist::detail::CompactCoordinatesFF<variable_bin_width>& data_j, int i, int j) {
            return data_i[i].evaluate_rounded_16(std::span<std::remove_reference_t<decltype(data_j[j])>, 16>(&data_j[j], 16));
        }
    }

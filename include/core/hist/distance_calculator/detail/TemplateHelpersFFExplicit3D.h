...
namespace ausaxs {
     ...
     * 
     * @tparam weighted_bins Whether to keep track of the distances added to the bins. This is useful for weighting the bins later.
    ...
    inline void evaluate8(
        typename hist::GenericDistribution3D<weighted_bins>::type& p_aa, typename hist::GenericDistribution3D<weighted_bins>::type& p_ax, typename hist::GenericDistribution3D<weighted_bins>::type& p_xx, 
        const hist::detail::CompactCoordinatesFF<variable_bin_width>& data_i, const hist::detail::CompactCoordinatesFF<variable_bin_width>& data_j, int i, int j
    ) {

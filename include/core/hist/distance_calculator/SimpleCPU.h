...
namespace ausaxs::hist::distance_calculator {
    ...
    class SimpleCPU : public SimpleKernel<weighted_bins, variable_bin_width> {
        ...
        public:
             ...
             */
            int enqueue_calculate_self(const hist::detail::CompactCoordinates<variable_bin_width>& a, int scaling = 1, int merge_id = -1) override;
             ...
             * @return The index of the data in the result vector.
             */
            int enqueue_calculate_cross(const hist::detail::CompactCoordinates<variable_bin_width>& a1, const hist::detail::CompactCoordinates<variable_bin_width>& a2, int scaling = 1, int merge_id = -1) override;

            /**
             * @brief Get the current size of the result vector.
             */
            int size_self_result() const override;
            int size_cross_result() const override; //< @copydoc size_self_result

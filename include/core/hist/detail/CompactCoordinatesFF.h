...
namespace ausaxs::hist::detail {
    ...
    struct CompactCoordinatesFF : public CompactCoordinatesTemplate<CoordinateTypeXYZFF, variable_bin_width, explicit_ff> {
        ...
        CompactCoordinatesFF(const std::vector<data::AtomFF>& atoms) : CompactCoordinatesTemplate<CoordinateTypeXYZFF, variable_bin_width, explicit_ff>(atoms) {setup();}
        CompactCoordinatesFF(const std::vector<data::Body>& bodies) : CompactCoordinatesTemplate<CoordinateTypeXYZFF, variable_bin_width, explicit_ff>(bodies) {setup();}
        CompactCoordinatesFF(const std::vector<data::Water>& atoms) : CompactCoordinatesTemplate<CoordinateTypeXYZFF, variable_bin_width, explicit_ff>(atoms) {setup();}

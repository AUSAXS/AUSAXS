...
namespace ausaxs::form_factor::lookup::exv {
    using table_t = container::ArrayContainer2D<NormalizedFormFactorProduct, form_factor::get_count_without_excluded_volume(), form_factor::get_count_without_excluded_volume()>;
    ...
    namespace normalized {
         ...
         */
        const NormalizedFormFactorProduct& get_product(unsigned int i, unsigned int j);

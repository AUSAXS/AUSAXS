...
namespace ausaxs::rigidbody::selection {
    ...
    class ManualSelect : public BodySelectStrategy {
        public:
             ...
             */
            ManualSelect(observer_ptr<const Rigidbody> rigidbody, int ibody);
             ...
             */
            ManualSelect(observer_ptr<const Rigidbody> rigidbody, int ibody, int isymmetry);
        ...
        private:
            int ibody = 0;      // The index of the body to be transformed.

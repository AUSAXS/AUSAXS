    ...
    namespace detail {
        ...
        class ResidueMap {
            public:
                 ...
                 */
                double get(const std::string& name, constants::atom_t atom) {return this->get(AtomKey(name, atom));}
                 ...
                 * @param value The number of bonds.
                 */
                void insert(const std::string& name, constants::atom_t atom, int value);

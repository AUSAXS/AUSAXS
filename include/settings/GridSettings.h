...
namespace settings {
    namespace grid {
        ...
        extern int exv_radius;       // The radius of the excluded volume sphere used for the grid-based excluded volume calculations in Å.
        extern bool save_exv;        // Whether to save the excluded volume grid when using the grid-based excluded volume calculations.

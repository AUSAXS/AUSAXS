    ...
    SECTION("scalar") {
        ...
        SECTION("sse") {
            block_tests<4>([](Atom s, Block b) {
                ...
                evaluate_4_sse_into<vbw, 4>(s, b, r.distance_bins.data(), r.ff_bins.data());
                return r;
            }, 1e-6);
        ...
        SECTION("avx") {
            block_tests<8>([](Atom s, Block b) {
                ...
                evaluate_8_avx_into<vbw, 8>(s, b, r.distance_bins.data(), r.ff_bins.data());
                return r;
            }, 1e-5);
        ...
        SECTION("avx512") {
            block_tests<16>([](Atom s, Block b) {
                ...
                evaluate_16_avx512_into<vbw, 16>(s, b, r.distance_bins.data(), r.ff_bins.data());
                return r;
            }, 1e-3);
